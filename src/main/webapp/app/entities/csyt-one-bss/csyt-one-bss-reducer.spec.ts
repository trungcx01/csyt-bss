...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CSYTONEBSS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CSYTONEBSS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CSYTONEBSS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CSYTONEBSS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CSYTONEBSS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CSYTONEBSS actions', async () => {
      const arg = 42666;
